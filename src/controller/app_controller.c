...
AppController *app_controller_new(GtkApplication *app) {
  ...
  g_signal_connect(controller->view->add_button, "clicked",
                   G_CALLBACK(on_add_button_clicked), controller);
...
static void on_add_button_clicked(GtkButton *button G_GNUC_UNUSED,
                                  gpointer user_data) {
